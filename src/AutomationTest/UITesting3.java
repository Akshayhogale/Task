...
public class UITesting3 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		File dest = new File("./screenshots/calley-pro-features.png");
        Files.copy(scr, dest);
		...
		File dest1 = new File("./screenshots/calley-pro-features1.png");
		...
		driver2.findElement(By.linkText("https://www.getcalley.com/calley-pro-features/")).click();
		TakesScreenshot ts2= (TakesScreenshot) driver;
		File scr2 = ts2.getScreenshotAs(OutputType.FILE);
		File dest2 = new File("./screenshots/calley-pro-features2.png");
