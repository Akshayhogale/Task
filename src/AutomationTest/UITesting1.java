...
public class UITesting1 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		File dest = new File("./screenshots/getcalley.png");
        Files.copy(scr, dest);
		...
		File dest1 = new File("./screenshots/getcalley1.png");
		...
		driver2.findElement(By.linkText("https://www.getcalley.com/")).click();
		TakesScreenshot ts2= (TakesScreenshot) driver;
		File scr2 = ts2.getScreenshotAs(OutputType.FILE);
		File dest2 = new File("./screenshots/getcalley2.png");
