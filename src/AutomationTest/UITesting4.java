...
public class UITesting4 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		File dest = new File("./screenshots/best-auto-dialer-app.png");
        Files.copy(scr, dest);
		...
		File dest1 = new File("./screenshots/best-auto-dialer-app1.png");
		...
		driver2.findElement(By.linkText("https://www.getcalley.com/best-auto-dialer-app/")).click();
		TakesScreenshot ts2= (TakesScreenshot) driver;
		File scr2 = ts2.getScreenshotAs(OutputType.FILE);
		File dest2 = new File("./screenshots/best-auto-dialer-app2.png");
