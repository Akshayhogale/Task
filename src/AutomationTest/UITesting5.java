...
public class UITesting5 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		File dest = new File("./screenshots/how-calley-auto-dialer-app-works.png");
        Files.copy(scr, dest);
		...
		driver1.findElement(By.linkText("https://www.getcalley.com/how-calley-auto-dialer-app-works/")).click();
		TakesScreenshot ts1 = (TakesScreenshot) driver;
		File scr1 = ts1.getScreenshotAs(OutputType.FILE);
		File dest1 = new File("./screenshots/how-calley-auto-dialer-app-works1.png");
		...
		driver2.findElement(By.linkText("https://www.getcalley.com/how-calley-auto-dialer-app-works/")).click();
		TakesScreenshot ts2= (TakesScreenshot) driver;
		File scr2 = ts2.getScreenshotAs(OutputType.FILE);
		File dest2 = new File("./screenshots/how-calley-auto-dialer-app-works2.png");
